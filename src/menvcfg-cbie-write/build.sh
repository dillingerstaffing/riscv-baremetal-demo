#!/bin/sh
# build.sh: build the menvcfg-cbie-write module from the repo root, using the
...
cd "$(dirname "$0")/../.."
$CC $CFLAGS -c src/boot.S -o src/boot_cbie.o
$CC $CFLAGS -c src/uart.c -o src/uart_cbie.o
$CC $CFLAGS -c src/menvcfg-cbie-write/cbie_main.c -o src/menvcfg-cbie-write/cbie_main.o
$CC $CFLAGS -c src/menvcfg-cbie-write/cbie_trap.S -o src/menvcfg-cbie-write/cbie_trap.o
$CC $CFLAGS -T link.ld -o menvcfg-cbie-write.elf \
  src/boot_cbie.o src/uart_cbie.o \
  src/menvcfg-cbie-write/cbie_main.o src/menvcfg-cbie-write/cbie_trap.o
echo "built menvcfg-cbie-write.elf"
