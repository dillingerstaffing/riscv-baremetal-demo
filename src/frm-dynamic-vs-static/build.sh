#!/bin/sh
# build.sh: build the frm-dynamic-vs-static module from the repo root.
...
run $CC $CFLAGS -c src/frm-dynamic-vs-static/fvs_main.c -o src/frm-dynamic-vs-static/fvs_main.o
run $CC $CFLAGS -c src/frm-dynamic-vs-static/fvs_trap.S -o src/frm-dynamic-vs-static/fvs_trap.o
run $CC $CFLAGS -T link.ld -o frm-dynamic-vs-static.elf \
  src/boot.o src/uart.o \
  src/frm-dynamic-vs-static/fvs_trap.o src/frm-dynamic-vs-static/fvs_main.o
echo "built frm-dynamic-vs-static.elf"
