#!/bin/sh
# build.sh: build the menvcfg-stce module from the repo root, using the
# same flags as the repo Makefile pattern. Run from the module
...
cd "$(dirname "$0")/../.."
$CC $CFLAGS -c src/boot.S -o src/boot_menv.o
$CC $CFLAGS -c src/uart.c -o src/uart_menv.o
$CC $CFLAGS -c src/menvcfg-stce/menv_main.c -o src/menvcfg-stce/menv_main.o
$CC $CFLAGS -c src/menvcfg-stce/menv_trap.S -o src/menvcfg-stce/menv_trap.o
$CC $CFLAGS -T link.ld -o menvcfg-stce.elf \
  src/boot_menv.o src/uart_menv.o \
  src/menvcfg-stce/menv_main.o src/menvcfg-stce/menv_trap.o
echo "built menvcfg-stce.elf"
